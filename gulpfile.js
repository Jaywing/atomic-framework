...
gulp.task("watch", function() {
  ...
  gulp.watch("./_docs/html/**/*", ["html:docs", browser.reload]);
  gulp.watch("./scss/**/*", ["sass:atomic", "sass:docs", browser.reload]);
  gulp.watch("./_docs/scss/**/*", ["sass:docs", browser.reload]);
  gulp.watch("./js/**/*", ["webpack", browser.reload]);
  gulp.watch("./images/**/*", ["images:atomic", browser.reload]);
  gulp.watch("./_docs/images/**/*", ["images:docs", browser.reload]);
  gulp.watch("./icons/*", ["icons:atomic", browser.reload]);
  gulp.watch("./_docs/icons/*", ["icons:docs", browser.reload]);

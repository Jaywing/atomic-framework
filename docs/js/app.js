...
/******/ 	__webpack_require__.p = "https://jaywing.github.io/atomic-framework/js/";
/******/
...
var _loop = function _loop() {
  ...
  __webpack_require__.e/* require.ensure */(0).then((function () {
    var Module = __webpack_require__(338)("./" + name).default;
    if (Module) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__modules_setUp__ = __webpack_require__(331);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__modules_setUp___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__modules_setUp__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_svgxuse__ = __webpack_require__(332);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_cut_the_mustard_advanced__ = __webpack_require__(333);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_cut_the_mustard_advanced___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_cut_the_mustard_advanced__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__asyncModules__ = __webpack_require__(125);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__asyncModules___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3__asyncModules__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__modules_Breakpoint__ = __webpack_require__(334);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__modules_FontLoader__ = __webpack_require__(335);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__modules_CopyrightYear__ = __webpack_require__(337);
...
function atomic_initialise() {
  ...
  __WEBPACK_IMPORTED_MODULE_5__modules_FontLoader__["a" /* default */].init(fontConfig);

  __WEBPACK_IMPORTED_MODULE_4__modules_Breakpoint__["a" /* default */].init(); // initialise breakpoint module

  Object(__WEBPACK_IMPORTED_MODULE_6__modules_CopyrightYear__["a" /* default */])("copyright-year");
...
if (__WEBPACK_IMPORTED_MODULE_2_cut_the_mustard_advanced___default()()) {
  atomic_initialise();
}
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_throttleit__ = __webpack_require__(126);
...
var EventName = "bpupdate";
var ThrottleTime = 250;
var breakpoint = {};
var breakpoints = ["base", "xxs", "xs", "sm", "md", "lg", "xl", "xxl"];
...
breakpoint.logUpdate = function (e) {
  var msg = "Breakpoint updated to " + e.detail.current;
...
breakpoint.init = function () {
  ...
  // when the window resizes, check for change
  "resize", __WEBPACK_IMPORTED_MODULE_0_throttleit___default()(breakpoint.checkForChange, ThrottleTime));
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_fontfaceobserver__ = __webpack_require__(336);
...
FontLoader.getGoogleUrl = function (familyName, fontFamily) {
  ...
  var i = 0;
  fontFamily.forEach(function (configItem) {
    if (i !== 0) url += ",";
...
FontLoader.init = function () {
  var fontFamilies = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];
  ...
  if (fontFamilies["custom"]) {
    var custom = fontFamilies["custom"];
    Object.keys(custom).forEach(function (family) {
      fontObservers.push(custom[family].map(function (config) {
        return new __WEBPACK_IMPORTED_MODULE_0_fontfaceobserver___default.a(family, config).load();
      }));
    });
  }

  if (fontFamilies["google"]) {
    var google = fontFamilies["google"];
    Object.keys(google).forEach(function (family) {
      // const url = this.getGoogleUrl(family, google[family])
      fontObservers.push(function () {
        return new __WEBPACK_IMPORTED_MODULE_0_fontfaceobserver___default.a(family).load();
      });
    });
  }
...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["a"] = updateCopyrightYear;
function updateCopyrightYear(id) {
  var dt = new Date();
  var curYear = dt.getYear() + 1900;
  var $cpYear = document.getElementById(id);
  var cpYear = void 0;
  if ($cpYear) {
